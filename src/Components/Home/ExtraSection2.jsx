...
const ExtraSection2 = () => {
  ...
  return (
    <div className="w-11/12 mx-auto mb-10 mt-72 md:mt-0">
      <div className="flex flex-col items-center  w-7/12 mx-auto text-center">
      ...
      <div className="w-9/12 mx-auto  grid grid-cols-1 md:grid-cols-2 gap-5">
        {reviews.map((review, idx) => (
          <div key={idx}>
            <div className="border p-5 h-64 md:h-72 lg:h-48 flex  flex-col lg:flex-row  items-center gap-5 hover:scale-105 duration-500">
